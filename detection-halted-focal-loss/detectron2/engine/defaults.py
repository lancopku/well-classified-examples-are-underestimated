...
""",
    ...
    # setup arguments for experiments of encourage loss
    # loss_clsz, base_loss, add_loss, power, beta, alpha, gamma
    parser.add_argument("--loss_clsz", type=str, default='fl', choices=['fl','ml','el'], help="")
    parser.add_argument("--base_loss", type=str, default='fl', choices=['fl', 'mle', 'mle_alpha'], help="only for loss_clsz ==el")
    parser.add_argument("--add_loss", type=str, default='zero', choices=['zero', 'ell', 'elp','efl','ell_regular'], help="")
    parser.add_argument("--log_end", type=float, default=1.0, help="end of the mirror log curve in ell and efl")
    parser.add_argument("--power", type=float, default=2.0, help="")
    parser.add_argument("--beta", type=float, default=1.0, help="alpha of bonus")
    parser.add_argument("--ita", type=float, default=0.0, help="gamma of bonus")
    parser.add_argument("--el_start", type=int, default=1, help="")
