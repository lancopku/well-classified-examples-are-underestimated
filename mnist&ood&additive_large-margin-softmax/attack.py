...
pretrained_model_ce = "/home/xxx/encourage_ns/lsoftmax-pytorch/bg0_le1.0_t0_acc99.41_best.pth"
pretrained_model_el = "/home/xxx/encourage_ns/lsoftmax-pytorch/bg-1_le1.0_t0_acc99.58_best.pth"
use_cuda=True
...
model_ce = MNISTNet(margin=1, device=device).to(device)
model_el = MNISTNet(margin=1, device=device).to(device)
